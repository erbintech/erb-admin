...
export class NavService implements OnDestroy {
    ...
    MENUITEMS: Menu[] = [
        ...
        // },
        {
            path: '/', title: 'Dashboard', icon: 'home', type: 'link'
        ...
        // {
        //     headTitle1: 'Loan', headTitle2: 'Loan Request',
        // },
        {
            title: 'Loans', icon: 'airplay', type: 'sub', active: false, children: [
                { path: '/personal-loan', title: 'Personal Loan', type: 'link' },
                { path: '/instant-loan', title: 'Instant Loan', type: 'link' },
                { path: '/business-loan', title: 'Business Loan', type: 'link' },
                { path: '/home-loan', title: 'Home Loan', type: 'link' },
                { path: '/LAP', title: 'LAP', type: 'link' }
            ]
        },
        {
            title: 'User Management', icon: 'users', type: 'sub', active: false, children: [
                { path: '/relationManager', title: 'Relation Manager', type: 'link' },
                { path: '/dsa', title: 'DSA', type: 'link' },
                { path: '/subdsa', title: 'SUBDSA', type: 'link' },
                { path: '/connector', title: 'Connector', type: 'link' },
                { path: '/employee', title: 'Employee', type: 'link' },
                { path: '/customers', title: 'Customer', type: 'link' }
            ]
        },
        {
            title: 'Master Pages', icon: 'youtube', type: 'sub', active: false, children: [
                { path: '/serviceType', title: 'Service Types', type: 'link' },
                // { path: '/services', title: 'Services', type: 'link' },
                { path: '/serviceEmploymentTypes', title: 'Service Employment Types', type: 'link' },
                { path: '/serviceDocument', title: 'Service Documents', type: 'link' },
                { path: '/documentMaster', title: 'Document Masters', type: 'link' },
                { path: '/trainingCategories', title: 'Training Categories', type: 'link' },
                { path: '/training', title: 'Trainings', type: 'link' },
                { path: '/maritalstatuses', title: 'MaritalStatuses', type: 'link' },
                { path: '/residencetype', title: 'ResidenceType', type: 'link' },
                { path: '/loanagainstcollteral', title: 'LoanAgainstCollteral', type: 'link' },
                { path: '/businessannualprofit', title: 'BusinessAnnualProfit', type: 'link' },
                { path: '/businessannualsale', title: 'BusinessAnnualSale', type: 'link' },
                { path: '/businessexperience', title: 'BusinessExperience', type: 'link' },
                { path: '/businessNature', title: 'BusinessNature', type: 'link' },
                { path: '/bank', title: 'Bank', type: 'link' },
                { path: '/industrytype', title: 'IndustryType', type: 'link' },
                // { path: '/loanstatus', title: 'LoanStatus', type: 'link' },
                { path: '/propertyType', title: 'PropertyType', type: 'link' },
                { path: '/employmentTypes', title: 'Employment Types', type: 'link' },
                { path: '/employmentServiceType', title: 'EmploymentServiceType', type: 'link' },
                { path: '/employmentNature', title: 'EmploymentNature', type: 'link' },
                { path: '/addressType', title: 'AddressType', type: 'link' },
                { path: '/coApplicantRelation', title: 'CoApplicantRelation', type: 'link' },
                { path: '/badges', title: 'Badges', type: 'link' },
                { path: '/bankLoan', title: 'BankLoan', type: 'link' },
                { path: '/rewardCoin', title: 'RewardCoin', type: 'link' },
                { path: '/banner', title: 'Banner', type: 'link' },
                { path: '/commissionTemplate', title: 'Commission Template', type: 'link' },
                { path: '/itr', title: 'Itr', type: 'link' },

            ]
        },
        {
            path: '/visitingCard', title: 'VisitingCard', type: 'link'
        },
        {
            path: '/commission', title: 'Commission', icon: 'percent', type: 'link'
        },
        {
            path: '/bankLoanPolicy', title: 'BankLoanPolicy', icon: 'percent', type: 'link'
        },
        {
            path: '/creditCard', title: 'CreditCard', type: 'link'
        },
        {
            path: '/otherLoan', title: 'OtherLoan', type: 'link'
        },
        {
            path: '/otherService', title: 'OtherService', type: 'link'
        },
        {
            path: '/faqs', title: 'Faqs', type: 'link'
        },
        {
            path: '/userScratchCard', title: 'USerScratchCard', type: 'link'
        },
        { 
            path: '/adminUSer', title: 'AdminUser', type: 'link' 
        },
       
        { 
            path: '/giftProduct', title: 'GiftProduct', type: 'link' 
        },
        { 
            path: '/order', title: 'Order', type: 'link' 
        },
        { 
            path: '/newsLetterSubscription', title: 'NewsLetterSubscription', type: 'link' 
        },
        {
            path: '/contactRequest', title: 'Contact Request', type: 'link'
        },
        // {
        // 	title: 'Dashboards', icon: 'home', type: 'sub', badgeType: 'success', badgeValue: '2', active: true, children: [
        // 		{ path: '/dashboard/default', title: 'Default', type: 'link' },
